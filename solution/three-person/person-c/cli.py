...
def build_parser() -> argparse.ArgumentParser:
    ...
    p_show.add_argument("--id", type=int, required=True, help="Todo ID")

    # --- update ---
    p_update = sub.add_parser("update", help="Update a todo's fields")
    p_update.add_argument("--id", type=int, required=True, help="Todo ID to update")
    ...
    p_delete.add_argument("--id", type=int, required=True, help="Todo ID to delete")
...
def cmd_update(args: argparse.Namespace) -> None:
    ...
    if not kwargs:
        print("No fields to update. Use --status, --priority, --title, --description, or --due.")
        return
